...
function Navigation($$payload, $$props) {
  ...
  $$payload.out += `<nav class="bg-white/95 backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50"><div class="max-w-7xl mx-auto px-6"><div class="flex justify-between items-center h-16"><a href="/" class="flex items-center group"><img src="/images/logo/weknowco-full-logo.png" alt="weKnowCO - Colorado Digital Marketing" class="h-10 w-auto hover:scale-105 transition-transform duration-200"/></a> <div class="hidden md:flex items-center space-x-8"><!--[-->`;
